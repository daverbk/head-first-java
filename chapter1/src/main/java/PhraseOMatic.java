public class PhraseOMatic {
    ...
    public static void main(String[] args) {
        ...
        String[] wordListTwo = { "уполномоченный", "трудный",
                ...
                "кластеризованный", "фирменный", "нестандартный ум", "позиционированный",
        ...
        String[] wordListThree = { "процесс", "пункт разгрузки",
                "вывод из положения", "тип структуры", "талант", "подход",
                "уровень завоеванного внимания", "портал", "период времени", "обзор",
